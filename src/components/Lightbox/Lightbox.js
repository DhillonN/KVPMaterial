  ...
  render() {
    ...
    return (
      <Fragment>
        <Gallery>
          {images.map((img, i) => (
            <GalleryItem key={img.localFile.childImageSharp.fluid.src}>
              <a href={img.localFile.childImageSharp.fluid.src} alt="Car Image" onClick={e => this.handleClick(e, i)}>
                <StyledImg sizes={img.localFile.childImageSharp.fluid.sizes} />
              </a>
            </GalleryItem>
          ))}
        </Gallery>
        ...
        <LightboxModal visible={showLightbox} onKeyUp={e => this.handleKeyDown(e)}>
          <LightboxContent>
            <Img fluid={images[selectedImage].localFile.childImageSharp.fluid} />
            <Controls>
